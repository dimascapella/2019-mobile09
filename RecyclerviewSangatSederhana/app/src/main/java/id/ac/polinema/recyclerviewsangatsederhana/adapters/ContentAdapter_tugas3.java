...
public class ContentAdapter_tugas3 extends RecyclerView.Adapter<ContentAdapter_tugas3.MyViewHolder> {

    private ArrayList<ItemContent> itemContents;
    private LayoutInflater inflater;

    public ContentAdapter_tugas3(ArrayList<ItemContent> itemContents, Context context) {
    ...
    @NonNull
    @Override
    public ContentAdapter_tugas3.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.tugas3_layout, parent, false);
        MyViewHolder holder = new MyViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull ContentAdapter_tugas3.MyViewHolder holder, int position) {
